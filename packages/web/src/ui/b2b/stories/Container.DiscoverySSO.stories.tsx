...
export const Login = {
  ...DiscoveryLogin,
  play: async ({ canvas }) => {
    await expect(await canvas.findByText('Use single sign-on')).toBeInTheDocument();
  },
} satisfies Story;
...
export const EmailPrompt = {
  ...Login,
  play: async ({ canvas }) => {
    const continueWithSsoButton = await canvas.findByText('Use single sign-on');
...
export const MultipleConnectionsBack = {
  ...
  play: async (params) => {
    ...
    await userEvent.click(await canvas.getByRole('button', { name: 'Go back' }));
  },
} satisfies Story;
...
export const NoConnections = {
  ...
  play: async (params) => {
    ...
    await expect(await canvas.getByPlaceholderText('Organization slug')).toBeInTheDocument();
    await expect(await canvas.getByRole('button', { name: 'Continue' })).toBeDisabled();
    await expect(await canvas.getByRole('button', { name: 'Try another method' })).toBeEnabled();
  },
} satisfies Story;
...
export const NoConnectionsOrgSlugNoSSO = {
  ...
  play: async (params) => {
    ...
    await userEvent.type(await canvas.findByLabelText('Organization slug'), 'no-sso-connections');
    await userEvent.click(await canvas.findByRole('button', { name: 'Continue' }));
...
export const NoConnectionsOrgSlugMultipleSSO = {
  ...
  play: async (params) => {
    ...
    await userEvent.type(await canvas.findByLabelText('Organization slug'), 'multiple-sso-connections');
    await userEvent.click(await canvas.findByRole('button', { name: 'Continue' }));
...
export const NoConnectionsInvalidOrgSlug = {
  ...
  play: async (params) => {
    ...
    await userEvent.type(await canvas.findByLabelText('Organization slug'), 'invalid-slug');
    await userEvent.click(await canvas.findByRole('button', { name: 'Continue' }));
...
export const NoConnectionsNetworkError = {
  ...
  play: async (params) => {
    ...
    await userEvent.type(await canvas.findByLabelText('Organization slug'), 'error-org');
    await userEvent.click(await canvas.findByRole('button', { name: 'Continue' }));
...
export const NoConnectionsTryAnotherMethod = {
  ...
  play: async (params) => {
    ...
    await userEvent.click(await canvas.findByText('Try another method'));
