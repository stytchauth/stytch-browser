import type { OneTapStartResponse, RPCManifest } from '@stytch/core';
...
const MockClientsideServicesProvider: jest.Mocked<RPCManifest> = {
  oneTapStart: jest.fn(),
  oneTapSubmit: jest.fn(),
  parsedPhoneNumber: jest.fn(),
  getExamplePhoneNumber: jest.fn(),
};
