...
import { Member, MemberSession, Organization } from '@stytch/vanilla-js';
...
} satisfies PartialDeep<jest.Mocked<StytchB2BHeadlessClient>>;
...
describe('StytchContext', () => {
  ...
  const renderWithProvider = (
    ui: ReactElement,
    { stytch = mockStytchClient as unknown as StytchB2BHeadlessClient, ...rest }: Partial<StytchB2BProviderProps> = {},
  ) =>
    render(
  ...
  it('normal usage', async () => {
    const { unmount } = render(<StytchB2BProvider stytch={mockStytchClient as unknown as StytchB2BHeadlessClient} />);
  ...
  it('nested stytch context errors', async () => {
    expectToThrow(
      () =>
        render(
          <StytchB2BProvider stytch={mockStytchClient as unknown as StytchB2BHeadlessClient}>
            <StytchB2BProvider stytch={mockStytchClient as unknown as StytchB2BHeadlessClient} />
          </StytchB2BProvider>,
        ),
