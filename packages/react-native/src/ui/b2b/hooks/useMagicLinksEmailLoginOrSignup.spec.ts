...
describe('useMagicLinksEmailLoginOrSignup', () => {
  beforeAll(() => {
  ...
  it('dispatches expected error when no email is present', async () => {
    ...
    await magicLinksEmailLoginOrSignup();
    expect(dispatchMock).toHaveBeenCalledWith({
      type: 'magicLinks/email/loginOrSignup/error',
  ...
  it('dispatches expected success when call succeeds', async () => {
    ...
    const { magicLinksEmailLoginOrSignup } = useMagicLinksEmailLoginOrSignup();
    await magicLinksEmailLoginOrSignup('org-id');
    expect(dispatchMock).toHaveBeenCalledWith({
