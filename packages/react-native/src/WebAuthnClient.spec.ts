...
describe('HeadlessWebAuthnClient', () => {
  ...
  describe('register', () => {
    ...
    it.skip('Automatically passes in the current document location and platform authenticator_type when no options are provided', async () => {
  ...
  describe('authenticate', () => {
    ...
    // eslint-disable-next-line jest/no-disabled-tests
    it.skip('Automatically passes in the current document location when no options are provided', async () => {
