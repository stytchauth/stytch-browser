  ...
  implements IHeadlessBiometricsClient<TProjectConfiguration>
{
  ...
  register = this._subscriptionService.withUpdateSession(async (options: BiometricsRegisterOptions) => {
  ...
  authenticate = this._subscriptionService.withUpdateSession(async (options: BiometricsAuthenticateOptions) => {
