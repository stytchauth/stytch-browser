...
import { MockClient, MockGlobalContextProvider, MockState } from './helpers';
import { render, screen, waitFor } from '../../../testUtils';
import React from 'react';
import Container from '../../b2b/Container';
import { DEFAULT_CONFIG } from '../../b2b/GlobalContextProvider';
...
import { writeB2BInternals } from '../../../utils/internal';
import { ConnectedAppPublic, StytchProjectConfigurationInput } from '@stytch/core/public';
import userEvent from '@testing-library/user-event';
import { Callbacks, IDPOAuthFlowMissingParamError, NoCurrentSessionError, StytchAPIError } from '@stytch/core/public';
...
describe('B2B IDP Consent Flow', () => {
  ...
  const renderIDPApp = ({
    ...
    writeB2BInternals(
      client as StytchB2BHeadlessClient<StytchProjectConfigurationInput>,
      {
        bootstrap: {
  ...
  it('Renders ungrantable scope section when ungrantable scopes are present', async () => {
    ...
    await screen.findByText("You cannot grant Sample Application's request to:");
