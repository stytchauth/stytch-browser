...
import { Products, Callbacks, StytchEventType } from '@stytch/core/public';
...
describe('Password Flow', () => {
  ...
  it('Successfully starts the reset password flow', async () => {
    ...
    await userEvent.click(screen.getByText('Resend email'));
  ...
  it('Successfully pivots to logging in without password from reset flow', async () => {
    ...
    await userEvent.click(screen.getByText('Login without a password'));
