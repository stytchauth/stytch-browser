...
import { Products, StytchEventType } from '@stytch/core/src/public';
import { StytchAPIError } from '@stytch/core/src/public';
import { setTimeout } from 'node:timers/promises';
import { usePromptPasskey } from './usePromptPasskey';
import { MockGlobalContextProvider, MockConfig, MockClient, MockState } from '../../testUtils';
...
import { useGlobalReducer } from '../b2c/GlobalContextProvider';
...
describe('usePromptPasskey', () => {
  ...
  const renderHookWithProviders = ({
    ...
    return renderHook(
      () => {
        const [prompt, error] = usePromptPasskey({ canAutofill });
