import { B2BOAuthProviders, B2BProducts, OrganizationBySlugMatch } from '@stytch/core/public';
import { waitFor, screen, fireEvent } from '@testing-library/preact';
import React from 'react';
import { GoogleOneTapClient } from '../../../oneTap/GoogleOneTapClient';
import { MockClient, renderWithConfig, FlowDefinition } from '../../flows/b2b/helpers';
import { SsoAndOAuthButtons, getCustomScopesForProvider, getProviderParamsForProvider } from './SsoAndOAuthButtons';
...
describe('CombinedAuthButtons', () => {
  ...
  const render = (buttons: (Component.OAuthButtons | Component.SSOButtons)[], options: FlowDefinition) =>
  ...
  it('respects the order of buttons in the buttons array', async () => {
    ...
    render([Component.SSOButtons, Component.OAuthButtons], {
      config: {
        products: [B2BProducts.emailMagicLinks, B2BProducts.oauth, B2BProducts.sso],
        oauthOptions: {
          providers: [B2BOAuthProviders.Google],
        },
      },
