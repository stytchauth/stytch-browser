...
export const EnrollmentRequiredSMSOTPComplete = {
  ...
  play: async (params) => {
    ...
    await userEvent.click(canvas.getByText('Text me a code'));
...
export const EnrollmentSMSOTPRequiredResend = {
  ...
  play: async (params) => {
    ...
    await userEvent.click(canvas.getByText('Resend code'));
...
export const SMSOTPEntryRequired = {
  ...
  play: async (params) => {
    ...
    await expect(queryByRole(canvasElement, 'button', { name: 'Back' })).not.toBeInTheDocument();
