...
const submitEmail = async (canvas: Canvas, email = 'test@stytch.com') => {
  ...
  await userEvent.click(canvas.getByText('Continue with email'));
};
...
export const FlowOrgOTPInvalidEmailResend = {
  ...OrgLoginOTPOnly,
  play: async ({ canvas }) => {
    await submitEmail(canvas, `inactive-email+${Date.now()}@stytch.com`);
...
export const FlowOrgOTPAndEMLChoiceBackPreserved = {
  ...
  play: async (params) => {
    ...
    expect(await canvas.findByPlaceholderText('example@email.com')).toHaveValue('test@stytch.com');
  },
} satisfies Story;
...
export const FlowOrgOTPAndEMLSubmitOTP = {
  ...
  play: async (params) => {
    ...
    await userEvent.click(canvas.getByText('Email me a log in code'));
...
export const FlowOrgOTPAndEMLSubmitEML = {
  ...
  play: async (params) => {
    ...
    await userEvent.click(canvas.getByText('Email me a log in link'));
...
export const FlowDiscoveryStepUp = {
  ...
  parameters: {
    ...
    stytch: {
      ...
      b2b: {
        ...
        config: {
          products: [B2BProducts.oauth, B2BProducts.emailMagicLinks, B2BProducts.emailOtp, B2BProducts.passwords],
        },
      },
    },
  },
  play: async ({ canvas }) => {
    ...
    await userEvent.click(canvas.getByText('Can join by email'));
...
export const FlowDiscoveryStepUpEML = {
  ...
  play: async (params) => {
    ...
    await userEvent.click(canvas.getByText('Email me a link'));
...
export const FlowDiscoveryStepUpEmailOTP = {
  ...
  play: async (params) => {
    ...
    await userEvent.click(canvas.getByText('Email me a code'));
