...
export const getConfiguredEmbeddedMode = (position: StringLiteralFromEnum<OneTapPositions> | undefined) => {
...
export const getShouldRenderEmbeddedOneTap = (position: StringLiteralFromEnum<OneTapPositions> | undefined) => {
...
export const getShouldRenderFloatingOneTap = (position: StringLiteralFromEnum<OneTapPositions> | undefined) => {
...
export const getRenderedOneTapMode = (position: StringLiteralFromEnum<OneTapPositions> | undefined) => {
  const embeddedMode = getConfiguredEmbeddedMode(position);
