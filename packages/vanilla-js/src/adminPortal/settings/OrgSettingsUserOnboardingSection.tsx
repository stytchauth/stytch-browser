...
import { B2BOrganizationsUpdateOptions, B2BProducts, Organization } from '@stytch/core/public';
...
import { getDisplayStatus, getDisplayKnownTenantProvider, getDisplayTenantProvider } from '../utils/getDisplay';
import { useConnections } from '../utils/useConnections';
import { ALL_OAUTH_TENANT_PROVIDERS, KnownOAuthTenantProvider, getMethodFromProvider } from '../utils/oAuthProviders';
...
const OrgSettingsUserOnboardingBody = ({
  ...
  const orgConfigAuthMethods = useAllowedAuthMethods();
  const ssoIsAllowedAuthMethod = useMemo(() => orgConfigAuthMethods.includes(B2BProducts.sso), [orgConfigAuthMethods]);
