...
const Playground = () => {
  ...
  const StytchComponent = useCallback(
    () => <StytchLogin config={Options[currentOption].config} styles={styleConfig} strings={strings} />,
    [currentOption, strings],
  );
